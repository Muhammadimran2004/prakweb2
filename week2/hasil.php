<?php
// ambil value yg diinput user dan simpan ke dalam variable
$proses = $_POST['proses'];
$nama = $_POST['nama'];
$matkul = $_POST['matkul'];
$uts = $_POST['uts'];
...
// panggil variable yang memiliki value kolom, tampilkan mengunakkan echo 
echo "proses : $proses";
echo "<br>Nama Lengkap : $nama";
echo "<br>Mata Kuliah Lengkap : $matkul";
echo "<br>Nilai UTS : $uts";
echo "<br>Nilai UAS : $uas";
echo "<br>Nilai Praktikum : $praktikum";
echo "<br>Rata-Rata Nilai : $rata_rata";
echo "<br>keterangan : $keterangan";
echo "<br>Grade : $grade";3,
?>